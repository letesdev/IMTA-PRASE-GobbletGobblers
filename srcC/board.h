 ...
 *
 * All the functions for having a game of gobblets or of gobblet-gobblers 
 * run are defined (author Dorbec).
 *  
 *
 */

/**
 * \mainpage Project 2021-2022 for IMT Atlantique, Campus Nantes
 ...
 * @return the player holding the biggest piece of that square, NO_PLAYER if no player
